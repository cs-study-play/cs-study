...
# Yarn의 구성<br>
![stru](https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FbwXQ6k%2FbtqVvODO28B%2FkK0yROyby7cOgaY4rkqlFk%2Fimg.png)
***ResourceManager***<br>
- 시스템의 모든 Application들 사이에서 자원을 관리/중재<br>
***NodeManager***<br>
- Container를 관리하고, CPU와 Memory와 같은 자원의 사용량을 모니터링<br>
***Application Master***<br>
- Resource Manager와 함께 자원을 협상하고, Task를 모니터링하고 실행하기 위해 Node Manager와 함께 작동<br>
# Yarn의 동작 방식
